...
# === Cabeçalho principal (fixo no topo da tela) ===
# Adiciona imagem full-width acima do conteúdo e sidebar
st.markdown("""
<style>
/* Forçar o cabeçalho acima de toda a página */
.cdb-global-header {
    position: fixed;
    top: 0;
    left: 0;
    width: 100vw;
    height: 180px; /* altura do cabeçalho */
    background-color: white;
    z-index: 9999;
}
.main, .block-container {
    padding-top: 200px !important; /* empurra o conteúdo para baixo */
}
</style>
""", unsafe_allow_html=True)

# Renderiza o header (usando o SVG da sua função)

...
st.markdown("<h3 style='text-align:center;'>📋Cadastro de Evolução: </h3><hr><br>", unsafe_allow_html=True)
with st.expander(f"⬇️ Dados do Paciente ⬇️  |  {paciente_info.get('NOME', 'Nome não cadastrado')}", expanded=False):

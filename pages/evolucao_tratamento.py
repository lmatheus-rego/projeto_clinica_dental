...
with col1:
    st.markdown(f"<h8 style='text-align:center;'>👤Tipo de Fissura:</h8><br>(f"<h10 style='text-align:center;'> {paciente_info.get('TIPO_FISSURA','')}</h10>", unsafe_allow_html=True)
